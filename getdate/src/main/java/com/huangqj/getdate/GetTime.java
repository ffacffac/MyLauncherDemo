...
/**
 * Created by huangqj on 2016/11/10.
 */
...
class SntpClient
{
	...
	private long read32(byte[] buffer, int offset)
	{
		...
		//		return ((long) i0 << 24) + ((long) i1 << 16) + ((long) i2 << < img class="wp-smiley" alt = "8)"
		//		src = "http://www.imobilebbs.com/wordpress/wp-includes/images/smilies/icon_cool.gif" > +(long) i3;
		return 0;
	}
